...
//type mmResourceChecker struct {
//	logger logr.Logger
//	reconciler *MattermostReconciler
//
//	mattermost *mattermostv1beta1.Mattermost
//
//	serviceName string
...
//		ingresName: mattermost.Name,
//		serviceAccountName: mattermost.Name,
//		roleName: mattermost.Name,
//		roleBindingName: mattermost.Name,
//	}
//
//	err := mmChecker.checkMattermostService(mattermost.GetProductionDeploymentName())
//	if err != nil {
//		return err
//	}
//
...
//}
//
//func (rc *mmResourceChecker) checkMattermostService(selectorName string) error {
//	desired := mattermostApp.GenerateService(rc.mattermost, rc.serviceName, selectorName)
//
//	err := rc.reconciler.createServiceIfNotExists(rc.mattermost, desired, rc.logger)
//	if err != nil {
//		return err
//	}
//
//	current := &corev1.Service{}
//	err = rc.reconciler.Client.Get(context.TODO(), types.NamespacedName{Name: desired.Name, Namespace: desired.Namespace}, current)
//	if err != nil {
//		return err
//	}
//
//	return rc.reconciler.update(current, desired, rc.logger)
//}
//
//func (rc *mmResourceChecker) checkMattermostRBAC() error {
//	err := rc.checkMattermostSA(mattermost, saName, reqLogger)
//	if err != nil {
//		return errors.Wrap(err, "failed to check mattermost ServiceAccount")
//	}
//	err = rc.checkMattermostRole(mattermost, roleName, reqLogger)
//	if err != nil {
//		return errors.Wrap(err, "failed to check mattermost Role")
//	}
//	err = rc.checkMattermostRoleBinding(mattermost, roleName, saName, reqLogger)
//	if err != nil {
//		return errors.Wrap(err, "failed to check mattermost RoleBinding")
//	}
//
...
//}
//
//func (rc *mmResourceChecker) checkMattermostSA() error {
...
//}
//
//func(rc *mmResourceChecker) checkMattermostRole() error {
...
//}
//
//func (rc *mmResourceChecker)  checkMattermostRoleBinding() error {
//	desired := mattermostApp.GenerateRoleBindingV1Beta(rc.mattermost, rc.roleName, rc.serviceAccountName)
//	err := rc.reconciler.createRoleBindingIfNotExists(rc.mattermost, desired, rc.logger)
//	if err != nil {
//		return err
//	}
//
...
//}
//
////func (r *MattermostReconciler) checkMattermost(mattermost *mattermostv1alpha1.ClusterInstallation, reqLogger logr.Logger) error {
////	reqLogger = reqLogger.WithValues("Reconcile", "mattermost")
////
////	err := r.checkMattermostService(mattermost, mattermost.Name, mattermost.GetProductionDeploymentName(), reqLogger)
////	if err != nil {
