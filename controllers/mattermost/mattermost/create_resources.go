...
func (r *MattermostReconciler) create(owner v1.Object, desired Object, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) update(current, desired Object, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createServiceAccountIfNotExists(owner v1.Object, serviceAccount *corev1.ServiceAccount, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createRoleBindingIfNotExists(owner v1.Object, roleBinding *rbacv1.RoleBinding, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createServiceIfNotExists(owner v1.Object, service *corev1.Service, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createIngressIfNotExists(owner v1.Object, ingress *v1beta1.Ingress, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createDeploymentIfNotExists(owner v1.Object, deployment *appsv1.Deployment, reqLogger logr.Logger) error {
...
func (r *MattermostReconciler) createRoleIfNotExists(owner v1.Object, role *rbacv1.Role, reqLogger logr.Logger) error {
